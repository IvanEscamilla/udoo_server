	...
	while(bCloseSocket == FALSE)
	{
		...
		{  
			...
			if(bChecksum == tCommand.CS)
			{
				...
				printf("data[0]: 	int val: %i 	hex val: %#2x 	size: %i \n",  tResponse.data[0], (uint8_t)tResponse.data[0], sizeof(tResponse.data[0]));
				printf("data[1]: 	int val: %i 	hex val: %#2x 	size: %i \n",  tResponse.data[1], (uint8_t)tResponse.data[1], sizeof(tResponse.data[1]));
				printf("data[2]: 	int val: %i 	hex val: %#2x 	size: %i \n",  tResponse.data[2], (uint8_t)tResponse.data[2], sizeof(tResponse.data[2]));
				printf("data[3]: 	int val: %i 	hex val: %#2x 	size: %i \n",  tResponse.data[3], (uint8_t)tResponse.data[3], sizeof(tResponse.data[3]));
				printf("data[4]: 	int val: %i 	hex val: %#2x 	size: %i \n",  tResponse.data[4], (uint8_t)tResponse.data[4], sizeof(tResponse.data[4]));
				printf("data[5]: 	int val: %i 	hex val: %#2x 	size: %i \n",  tResponse.data[5], (uint8_t)tResponse.data[5], sizeof(tResponse.data[5]));
				printf("data[6]: 	int val: %i 	hex val: %#2x 	size: %i \n",  tResponse.data[6], (uint8_t)tResponse.data[6], sizeof(tResponse.data[6]));
				printf("data[7]: 	int val: %i 	hex val: %#2x 	size: %i \n",  tResponse.data[7], (uint8_t)tResponse.data[7], sizeof(tResponse.data[7]));
				printf("data[8]: 	int val: %i 	hex val: %#2x 	size: %i \n",  tResponse.data[8], (uint8_t)tResponse.data[8], sizeof(tResponse.data[8]));
